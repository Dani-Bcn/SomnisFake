import { motion as m, scale } from "framer-motion";
...
export default function Viscoelatica() {
  ...
  return (
    <m.div
      className="w-screen py-20  p-5 lg:p-10 flex flex-col gap-5 bg-[#ac947a]  "
    ...
    >
      <m.h2
        ...
        className="mt-20 lg:mt-50 text-6xl lg:text-9xl bebas-neue-regular z-10"
      >
        Viscoelastica
      </m.h2>
      <div className=" lg:hidden overflow-hidden">
        <m.img
          ...
          className="scale-200"
          src="https://assets.zyrosite.com/cdn-cgi/image/format=auto,w=1920,fit=crop/YBgjMgabRgiQr27z/visco_baja-mnl4o8wWR2CbrBxb.png"
          alt=""
        />
      </div>
      <img
        className=" reveal  hidden lg:block  lg:mr-60 absolute inset-0 mx-auto mt-20 w-100 lg:w-4/12 opacity-50 pointer-events-none"
      ...
      <div className="   gap-10 lg:flex-row flex-col relative z-10 max-w-6xl">
        <div className="gap-5 flex flex-col text-gray-100 font-semibold">
          <p>
            ...
            ofereixen una adaptabilitat perfecta perquè cada nit gaudiu d'un
            somni reparador que us permeti començar cada dia ple d'energia.
          </p>
        </div>
      </div>
    </m.div>
